					...
					<div class="row">
						<div class="col-xl-8">
							<ul class="list-unstyled">
								<li class="text-muted">To: <span style="color: #5d9fc5;">Cosumer</span></li>
								<li class="text-muted">adress</li>
								<li class="text-muted">Madhaya pardesh, india</li>
						...
						<div class="col-xl-4">
							...
							<ul class="list-unstyled">
								<li class="text-muted"><i class="fas fa-circle"
									style="color: #84B0CA;"></i> <span class="fw-bold">ID:</span>#123-456</li>
								<li class="text-muted"><i class="fas fa-circle"
								...
								<li class="text-muted"><i class="fas fa-circle"
									...
									class="badge bg-warning text-black fw-bold"> Unpaid</span></li>
							</ul>
						</div>
					</div>
