	...
	<div class="main-wrapper">
	    ...
	    if(al!=null&&al.size()>0){
            for(int i=0; i<al.size(); i++)
            {
            	...
            	%>
						<td><a
							href="ToUpdateServlet?action=accepted&docid=<%=ap.getDoc_id()%>"><button
									class="btn btn-rounded btn-outline-info mb-2" name="b1"
									value="Accept">Accept</button></a></td>
						<td><a
							href="ToUpdateServlet?action=canceled&docid=<%=ap.getDoc_id()%>"><button
									class="btn btn-rounded btn-outline-info mb-2" name="b1"
									value="cancel">Cancel</button></a></td>
