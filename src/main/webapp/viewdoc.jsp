						...
						<div class="appointments">
							...
							<div class="appointment-list">
								<div class="profile-info-widget">
									<a href="patient-profile.html" class="booking-doc-img"> <img
								...
								<div class="appointment-action">
									<a href="#" class="btn btn-sm bg-info-light"
										data-toggle="modal" data-target="#appt_details"> <i
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-map-marker-alt"></i> North Carolina, United
												States
											</h5>
											<h5>
												<i class="fas fa-envelope"></i> charlenereed@example.com
											</h5>
											<h5 class="mb-0">
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-map-marker-alt"></i> Maine, United States
											</h5>
											<h5>
												<i class="fas fa-envelope"></i> travistrimble@example.com
											</h5>
											<h5 class="mb-0">
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-envelope"></i> carlkelly@example.com
											</h5>
											<h5 class="mb-0">
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-map-marker-alt"></i> Indiana, United States
											</h5>
											<h5>
												<i class="fas fa-envelope"></i> michellefairfax@example.com
											</h5>
											<h5 class="mb-0">
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-envelope"></i> ginamoore@example.com
											</h5>
											<h5 class="mb-0">
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-envelope"></i> elsiegilley@example.com
											</h5>
											<h5 class="mb-0">
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-map-marker-alt"></i> California, United
												States
											</h5>
											<h5>
												<i class="fas fa-envelope"></i> joangardner@example.com
											</h5>
											<h5 class="mb-0">
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-map-marker-alt"></i> New Jersey, United
												States
											</h5>
											<h5>
												<i class="fas fa-envelope"></i> danielgriffing@example.com
											</h5>
											<h5 class="mb-0">
								...
								<div class="profile-info-widget">
									...
									<div class="profile-det-info">
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-envelope"></i> walterroberson@example.com
											</h5>
											<h5 class="mb-0">
							...
							<div class="appointment-list">
								<div class="profile-info-widget">
									<a href="patient-profile.html" class="booking-doc-img"> <img
										src="assets/img/patients/patient10.jpg" alt="User Image">
									</a>
									<div class="profile-det-info">
										<h3>
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-envelope"></i> robertrhodes@example.com
											</h5>
											<h5 class="mb-0">
							...
							<div class="appointment-list">
								<div class="profile-info-widget">
									<a href="patient-profile.html" class="booking-doc-img"> <img
										src="assets/img/patients/patient11.jpg" alt="User Image">
									</a>
									<div class="profile-det-info">
										<h3>
										...
										<div class="patient-details">
											...
											<h5>
												<i class="fas fa-envelope"></i> harrywilliams@example.com
											</h5>
											<h5 class="mb-0">
					...
					<ul class="info-details">
						<li>
							<div class="details-header">
								<div class="row">
									<div class="col-md-6">
										<span class="title">#APT0001</span> <span class="text">21
											Oct 2019 10:00 AM</span>
									</div>
									<div class="col-md-6">
						...
						<li><span class="title">Status:</span> <span class="text">Completed</span>
						</li>
						<li><span class="title">Confirm Date:</span> <span
							class="text">29 Jun 2019</span></li>
						<li><span class="title">Paid Amount</span> <span class="text">$450</span>
						</li>
					</ul>
				</div>
			</div>
