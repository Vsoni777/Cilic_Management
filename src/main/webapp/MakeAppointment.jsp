			...
			<nav class="navbar navbar-expand-lg header-nav">
				...
				<div class="main-menu-wrapper">
					...
					<ul class="main-nav">
						...
						<li class="has-submenu active"><a href="#">Pages <i
								class="fas fa-chevron-down"></i></a>
							<ul class="submenu">
				...
				<ul class="nav header-navbar-rht">
					...
					<li class="nav-item"><a class="nav-link header-login"
						href="Admin.html">login / Signup</a></li>
				</ul>
			</nav>
		</header>
		<!-- /Header -->
													...
													<div class="col-md-6 mb-4">
														...
														<div class="form-outline">
															<input type="text" id="firstName"
																class="form-control form-control-lg" name="t1">
													...
													<div class="col-md-6 mb-4">
														...
														<div class="form-outline">
															<input type="text" id="lastName"
																class="form-control form-control-lg" name="t2">
													...
													<div class="col-md-6 mb-4 d-flex align-items-center">
														...
														<div class="form-check form-check-inline">
															<input class="form-check-input" type="radio"
																name="inlineRadioOptios" id="femaleGender"
													...
													<div class="col-md-6 mb-4 pb-2">
														...
														<div class="form-outline">
															<input type="date" id="Appointmentdate"
																class="form-control form-control-lg" name="t3">
													...
													<div class="col-md-6 mb-4 pb-2">
														...
														<div class="form-outline">
															<input type="tel" id="phoneNumber"
																class="form-control form-control-lg" name="t4">
